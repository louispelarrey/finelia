    ...
    $(document).ready(function () {
        ...
        $('#myCalendar').pagescalendar({
            ...
            events: [{
                    ...
                    title: 'Oui1',
                    class: 'bg-success-lighter notEditable',
                    start: moment('2021-01-14T02:00:00'),
                    end: moment('2021-01-14T06:00:00'),
                    editable: false,
                    readOnly: true,
                    other:{}
                },{
            ...
            onEventClick: function (event) {
                ...
                if (!$('#calendar-event').hasClass('open') || !$('#calendar-event').hasClass('notEditable'))
        ...
        $('#myCalendar').pagescalendar("setLocale", "fr");
    });
